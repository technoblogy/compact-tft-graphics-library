/* Compact TFT Graphics Library for GC9A01A - see http://www.technoblogy.com/show?2LMJ

   David Johnson-Davies - www.technoblogy.com - 15th March 2026
...
const int cs = 0; // TFT display SPI chip select pin
const int dc = 3; // TFT display data/command select pin

// Display parameters

// Adafruit 1.28" Round 240x240 display GC9A01A driver
int const xsize = 240, ysize = 240, xoff = 0, yoff = 0, invert = 1, rotate = 7, bgr = 0;
